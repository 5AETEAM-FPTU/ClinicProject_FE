            ...
            {!reportId! ? (<NotFound />) : (
                ...
                >
                    <Layout className="flex h-fit flex-col bg-transparent gap-2 shadow-third p-4 rounded-lg">
                                ...
                                <div className="flex flex-col lg:flex-row gap-5 mt-2">
                                    ...
                                    <div className="lg:w-1/3 w-full">
                                        ...
                                        <div className="flex gap-4 pt-8">
                                            ...
                                            {!medicalRecord?.isFeedbackExist ? (<Button className="font-bold text-[#003553] py-4" onClick={() => setIsModalOpen(!isModalOpen)}>Gửi đánh giá<SendHorizontal size={20} /></Button>
                                            )
                                                : <Button className="font-bold text-[#003553] py-4" onClick={() => setIsModalOpenView(!isModalOpenView)}>Xem đánh giá<View size={20} /></Button>}
                                        </div>
                                    </div>
                                </div>
                            </>)}
                        ...
                        <ViewFeedback close={() => setIsModalOpenView(!isModalOpenView)} open={isModalOpenView} />
                    </Layout>
                </motion.div>)}
        </>
    )
