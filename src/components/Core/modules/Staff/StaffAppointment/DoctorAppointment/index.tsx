...
import { DatePicker, Collapse, Divider, Button, Skeleton, Avatar } from 'antd'
import { Calendar, ChevronDown, ChevronUp, Dot } from 'lucide-react'
import "./style.css"
...
export default function DoctorBookedAppointmentsList({ doctorId }: { doctorId: string }) {
    ...
    const { data: appointmentReponse, refetch, isFetching } = useGetAppointmentInWeekQuery({ startDate: dateFilter[0], endDate: dateFilter[1], doctorId: doctorId });
