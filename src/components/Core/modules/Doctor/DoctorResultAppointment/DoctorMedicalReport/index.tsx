...
export default function DoctorMedicalReport({ reports }: IProps) {
    ...
    return (
        <>
            <div 
            onClick={() => {router.push("treatment-history/view?id=" + reports.reportId)}}
            className="flex h-fit cursor-pointer flex-col gap-2 rounded-xl bg-white p-[16px] shadow-third transition-all hover:bg-slate-100 sm:gap-0">
