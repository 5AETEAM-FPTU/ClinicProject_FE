                                ...
                                <ul className="space-y-1">
                                    {patientQueues.map((queue) => (
                                        <li
                                            ...
                                            className="shadow-sm flex h-fit flex-col items-center justify-between rounded-lg bg-white px-4 lg:h-[70px] lg:flex-row"
                                        >
                                            <div className="flex min-w-[250px] items-center gap-2 pt-2 lg:pt-2">
                                                <Image
                                            ...
                                            <div className="mt-2 flex w-[80%] items-center lg:w-[60%]">
                                            ...
                                            <Button
                                                ...
                                                type="primary"
                                                className="m-3 flex items-center rounded-xl bg-secondaryDark px-5 py-5 font-bold text-white"
                                            >
