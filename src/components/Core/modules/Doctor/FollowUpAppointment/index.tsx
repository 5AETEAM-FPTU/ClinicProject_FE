...
const patients: Patient[] = [
    { id: '1', name: 'Tên bệnh nhân', address: 'thôn A, xã B, thành phố C', gender: 'nam', age: 29, image: '/placeholder.svg?height=60&width=60' },
    { id: '2', name: 'Tên bệnh nhân', address: 'thôn A, xã B, thành phố C', gender: 'nam', age: 29, image: '/placeholder.svg?height=60&width=60' },
    { id: '3', name: 'Tên bệnh nhân', address: 'thôn A, xã B, thành phố C', gender: 'nam', age: 29, image: '/placeholder.svg?height=60&width=60' },
    { id: '4', name: 'Tên bệnh nhân', address: 'thôn A, xã B, thành phố C', gender: 'nam', age: 29, image: '/placeholder.svg?height=60&width=60' },
    { id: '5', name: 'Tên bệnh nhân', address: 'thôn A, xã B, thành phố C', gender: 'nam', age: 29, image: '/placeholder.svg?height=60&width=60' },
]
...
export default function FollowUpAppointment() {
    ...
    const ReExaminationForm = () => (
        <div className="p-4 w-64">
            ...
            />
            <DatePicker className="w-full mb-4" placeholder="Ngày tái khám" />
