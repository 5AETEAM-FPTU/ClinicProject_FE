    ...
    return (
        <motion.div initial={{ opacity: 0, translateY: 10 }} animate={{ opacity: 1, translateY: 0 }} exit={{ opacity: 0 }}>
            ...
            <Content style={{ padding: '0px' }}>
                ...
                <Card bordered={false} headStyle={{ borderBottom: 'none' }} className='h-full !shadow-third' title={<div className='text-xl text-secondarySupperDarker font-bold'>Thành tựu</div>} style={{ marginTop: '24px' }}>
